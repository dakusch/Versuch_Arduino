...
class fm-receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm-receiver")
        ...
        if len('/home/david/Nextcloud/Arbeit_ANT/Versuch_Arduino/Neural_Net/GUI/images/antlogo.png') > 0:
            bkgnd="background-image: url(" + '/home/david/Nextcloud/Arbeit_ANT/Versuch_Arduino/Neural_Net/GUI/images/antlogo.png' + "); background-repeat: repeat_n; background-position: " + "center" + ";"
        else:
            bkgnd = ''
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.analog_fm_demod_cf_0, 0))
...
def main(top_block_cls=fm-receiver, options=None):
