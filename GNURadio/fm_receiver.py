...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq = freq = 105900000

        ##################################################
        # Blocks
        ##################################################

        self._freq_range = qtgui.Range(89000000, 108000000, 100000, 105900000, 200)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(1, firdes.low_pass(1, samp_rate, 200000, 50000, window.WIN_HAMMING, 6.76), 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 200000, 50000, window.WIN_HAMMING, 6.76))
