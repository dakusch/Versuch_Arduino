...
import Neural_Net_Decoder_epy_block_0 as epy_block_0  # embedded python block
import Neural_Net_Decoder_epy_block_1 as epy_block_1  # embedded python block
import sip



class Neural_Net_Decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Neural_Net_Decoder")
        ...
        self._noise_amplitude_range = Range(0, 10, .01, 0, 200)
        ...
        self.epy_block_0 = epy_block_0.KerasOOKDecoder(offset=0)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_int_to_float_0 = blocks.int_to_float(1, 1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, (samp_rate/sps/2), 1, 0, 0)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.analog_sig_source_x_0.set_frequency((self.samp_rate/self.sps/2))
        self.epy_block_1.symbol_length = self.sps
...
def main(top_block_cls=Neural_Net_Decoder, options=None):
