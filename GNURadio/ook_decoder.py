...
class ook_decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.blk(threshold=threshold, windowsize=sps)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_int_to_float_0 = blocks.int_to_float(1, 1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, (samp_rate/(2*sps)), 1, 0, 0)
        ...
        self.connect((self.blocks_int_to_float_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.epy_block_1, 0), (self.blocks_int_to_float_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.analog_sig_source_x_0.set_frequency((self.samp_rate/(2*self.sps)))
